...
これらのことを実際にテストすることで、我が国で使われているEPUBリーダーが、どの程度EPUB 3.3に適合しているのか分かるだろう。それだけではない、EPUB 3.3は国際規格だ。ということは、このテストは日本のEPUBリーダーの「国際的な立ち位置」をも浮き彫りにするはずだ、そのように私達は考えた。
