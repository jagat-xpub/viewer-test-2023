...
他方、他社製レイアウトエンジンを使うと独自機能の追加がむずかしくなるなど、開発の柔軟性が下がるデメリットが考えられる。これを嫌ってだろうか、独自にレイアウトエンジンを実装するEPUBリーダーも多い。代表的なのはKindle、他にもモバイル版以外の楽天kobo、honto、Kinoppy、Romancerがこれにあたる。
