...
したがって、電書協ガイドver.1.1.3が求める「CSS レベル2.1のサブセットと上記1〜3」のほとんどが本テストの対象外だ。その上での仮説だが、独自エンジン系のリーダーがこの「20150101-CSS機能一覧.pdf」のサポートだけでよいと割り切った実装をしたとすれば、最新のCSSモジュールのサポートに消極的だった理由として説明がつくのではないか。
